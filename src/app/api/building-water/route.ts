...
const metersMap: Record<string, string> = {
  air_cooling_water_building2: "water_bldg2",
  air_cooling_water_building1: "water_bldg1",
  water_usage_building2: "water_usage2",
  water_usage_building1: "water_usage1",
  reused_treated_water: "water_reused",
  drinking_water: "water_drinking"
};
